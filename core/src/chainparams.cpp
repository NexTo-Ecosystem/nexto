...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1735540102, 501000, 0x1e0ffff0, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf115ea61f4b1c6dd5071634ee64f0590bf31a902e8b01e2d0f7a26d5311ee756"));
        assert(genesis.hashMerkleRoot == uint256S("0x7aebedac56a8673ac3ba421804a023d8ab8ae99fe2d4249260482b3bbbb47d86"));
        ...
        consensus.nTime_RejectOldSporkKey = 1711943762;     //!> Fully reject old spork key after Tue, 31 May 2022 00:00:00 GMT
        ...
        vSeeds.emplace_back("103.102.15.162", false);     // seed-main
        vSeeds.emplace_back("178.16.131.113", false);     // second-seed-main

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 112);      // n
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 75);      // A
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x02, 0x49, 0x70, 0xca};
        base58Prefixes[EXT_SECRET_KEY] = {0x02, 0x06, 0x18, 0x5f};
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = {0x02, 0x45, 0xb1, 0x82};
